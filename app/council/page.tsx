...
export default function CouncilPage() {
  ...
  const generateMockPerspective = (sage: any, query: string) => {
    const perspectives = {
        ...
        <main className="container mx-auto px-4 py-8">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
              ...
              <Card
                className="bg-gradient-to-br from-orange-500/20 to-yellow-500/20 backdrop-blur-xl border-2 border-orange-500/30 p-4 rounded-2xl animate-float"
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
                {displayedSages.map((sage) => (
                  ...
                  >
                    ...
                    <div className="text-xs text-slate-400 mt-1">{sage.specialty || sage.role}</div>
                  </button>
                ))}
              </div>
              {selectedSages.length > 0 && (
              ...
              <div className="space-y-6 animate-fade-in">
                ...
                <div>
                  ...
                  <div className="grid md:grid-cols-2 gap-4">
                    {deliberation.perspectives?.map((perspective: any, i: number) => (
                      <Card
                        key={i}
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3 pr-2">
                {filteredSages.map((sage) => (
                  ...
                  >
                    ...
                    <div className="text-xs text-slate-400 mt-1 truncate">{sage.specialty}</div>
