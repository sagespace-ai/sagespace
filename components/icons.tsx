export function HumanPrimacyIcon() {
  return (
    <svg
      viewBox="0 0 100 100"
      fill="none"
    ...
    >
      {/* Head */}
      <circle cx="50" cy="28" r="14" fill="rgba(34, 211, 238, 0.3)" stroke="currentColor" strokeWidth="2" />
      {/* Body with authority lines */}
      <rect
        x="40"
        y="44"
        width="20"
        ...
        strokeWidth="2"
      />
      {/* Arms extended upward - authority */}
      <line x1="40" y1="48" x2="25" y2="32" strokeWidth="3" strokeLinecap="round" />
      <line x1="60" y1="48" x2="75" y2="32" strokeWidth="3" strokeLinecap="round" />
      {/* Authority crown rays upward */}
      <g className="animate-pulse" style={{ animationDuration: "2s" }}>
        <line x1="50" y1="14" x2="50" y2="6" strokeWidth="2.5" />
        <line x1="58" y1="18" x2="65" y2="10" strokeWidth="2.5" />
        <line x1="42" y1="18" x2="35" y2="10" strokeWidth="2.5" />
      </g>
    </svg>
  )
}

export function AutonomyIcon() {
  return (
    <svg
      viewBox="0 0 100 100"
      fill="none"
      ...
      strokeLinecap="round"
      strokeLinejoin="round"
      className="w-16 h-16 text-accent-secondary"
    >
      {/* Central hub */}
      ...
      <g className="animate-spin" style={{ animationDuration: "3s" }}>
        ...
        <line x1="50" y1="50" x2="50" y2="20" strokeWidth="1" opacity="0.3" />
      </g>
      <g className="animate-spin" style={{ animationDuration: "3s", animationDelay: "-1s" }}>
        <circle cx="75" cy="50" r="6" />
        <line x1="50" y1="50" x2="75" y2="50" strokeWidth="1" opacity="0.3" />
      </g>
      <g className="animate-spin" style={{ animationDuration: "3s", animationDelay: "-2s" }}>
        <circle cx="50" cy="80" r="6" />
        <line x1="50" y1="50" x2="50" y2="80" strokeWidth="1" opacity="0.3" />
      </g>
      <g className="animate-spin" style={{ animationDuration: "3s", animationDelay: "-0.5s" }}>
        <circle cx="25" cy="50" r="6" />
        <line x1="50" y1="50" x2="25" y2="50" strokeWidth="1" opacity="0.3" />
      </g>
    </svg>
  )
}
...
export function TransparencyIcon() {
  return (
    ...
    >
      ...
      <circle cx="50" cy="50" r="24" className="animate-pulse" style={{ animationDuration: "2.5s" }} opacity="0.4" />
      {/* Middle circle */}
      <circle
        cx="50"
        cy="50"
      ...
      />
      {/* Transparency rays pointing outward */}
      <g opacity="0.7" className="animate-glow">
        <line x1="50" y1="22" x2="50" y2="10" strokeWidth="2" />
        <line x1="70" y1="30" x2="80" y2="20" strokeWidth="2" />
        <line x1="78" y1="50" x2="90" y2="50" strokeWidth="2" />
        <line x1="70" y1="70" x2="80" y2="80" strokeWidth="2" />
        <line x1="50" y1="78" x2="50" y2="90" strokeWidth="2" />
        <line x1="30" y1="70" x2="20" y2="80" strokeWidth="2" />
        <line x1="22" y1="50" x2="10" y2="50" strokeWidth="2" />
...
export function HarmonyIcon() {
  return (
    <svg
      ...
      className="w-16 h-16 text-cyan-400"
    >
      {/* Three flowing waves representing harmony */}
      <g className="animate-bob" style={{ animationDuration: "3s" }}>
        <path d="M 20 50 Q 30 40 40 50 T 60 50 T 80 50" strokeWidth="2" opacity="0.8" />
      </g>
      <g className="animate-bob" style={{ animationDuration: "3s", animationDelay: "0.2s" }}>
        <path d="M 20 65 Q 30 55 40 65 T 60 65 T 80 65" strokeWidth="2" opacity="0.6" />
      </g>
      <g className="animate-bob" style={{ animationDuration: "3s", animationDelay: "0.4s" }}>
        <path d="M 20 35 Q 30 25 40 35 T 60 35 T 80 35" strokeWidth="2" opacity="0.6" />
      </g>
      {/* Central nodes */}
      <circle cx="40" cy="50" r="5" fill="currentColor" opacity="0.7" />
      <circle cx="60" cy="50" r="5" fill="currentColor" opacity="0.7" />
    </svg>
  )
}

export function EquilibriumIcon() {
  return (
    <svg
      viewBox="0 0 100 100"
      fill="none"
    ...
    >
      ...
      {/* Fulcrum */}
      <polygon points="50,50 45,60 55,60" fill="currentColor" />

      {/* Left pan */}
      <g className="animate-balance" style={{ transformOrigin: "50px 50px" }}>
        <rect x="25" y="35" width="15" height="10" rx="1" />
        <line x1="30" y1="35" x2="30" y2="28" strokeWidth="1" opacity="0.6" />
        <line x1="37" y1="35" x2="37" y2="28" strokeWidth="1" opacity="0.6" />
      </g>

      {/* Right pan */}
      <g
        className="animate-[balance_3s_ease-in-out_infinite]"
        style={{ animationDelay: "0.15s", transformOrigin: "50px 50px" }}
      >
        <rect x="60" y="35" width="15" height="10" rx="1" />
        <line x1="65" y1="35" x2="65" y2="28" strokeWidth="1" opacity="0.6" />
        <line x1="72" y1="35" x2="72" y2="28" strokeWidth="1" opacity="0.6" />
      </g>
...
export function Loader2Icon({ className = "w-4 h-4" }: { className?: string }) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
...
export function Trash2Icon({ className = "w-4 h-4" }: { className?: string }) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
...
export function TrendingUpIcon({ className = "w-4 h-4" }: { className?: string }) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
...
export function XCircleIcon({ className = "w-4 h-4" }: { className?: string }) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
...
export function PaletteIcon({ className = "w-4 h-4" }: { className?: string }) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
...
export function Database({ className = "w-4 h-4" }: { className?: string }) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
...
export function Copy({ className = "w-4 h-4" }: { className?: string }) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
...
export function StopCircleIcon({ className = "w-4 h-4" }: { className?: string }) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
...
export function Share2Icon({ className = "w-4 h-4" }: { className?: string }) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
