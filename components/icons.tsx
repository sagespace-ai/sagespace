// SageSpace Icon Library - All icons used across the Agent Universe
...
export function SparklesIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      ...
      {...props}
    >
      <path d="M12 3l1.912 5.813a2 2 0 0 0 1.275 1.275L21 12l-5.813 1.912a2 2 0 0 0-1.275 1.275z" />
    </svg>
  )
}
...
export function ImageIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    ...
    >
      ...
      <path d="m21 15-3.086-3.482a2 2 0 0 0-2.828 0L6 21" />
    </svg>
  )
}
...
export function RefreshCwIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="24"
