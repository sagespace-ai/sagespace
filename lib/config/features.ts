...
export const AI_CONFIG = {
  ...
  textModel: process.env.TEXT_MODEL || "llama-3.3-70b-versatile",
  audioModel: process.env.AUDIO_MODEL,
  imageModel: process.env.IMAGE_MODEL,
  videoModel: process.env.VIDEO_MODEL,
  gatewayEnabled: process.env.FEATURE_GATEWAY === "true",
  mediaResponsesEnabled: process.env.FEATURE_MEDIA_RESPONSES === "true",
}
